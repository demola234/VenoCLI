...
func getVideoAudioFormats(v *fileutils.Video, quality string, mimetype, language string) (*fileutils.Format, *youtube.Format, error) {
...
func DownloadFile(ctx context.Context, v *youtube.Video, format *youtube.Format, outputFile string) error {
